...
class PhilosopherInteractor {
    ...
    fun getById(philosopherId: Int): Philosopher {
        return philosopherMap.getOrDefault(philosopherId, Philosopher(0, "Inconnu", "", mutableListOf()))
    }

    fun addQuote(philosopherId: Int, newQuote: String) {
        getById(philosopherId).addQuote(newQuote)
    }
}